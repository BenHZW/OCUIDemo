...
@interface RootTableViewController ()
{
    ...
    //搜索代理人
    SearchDisplayDelegate *_searchDisplayDelegate;
}
@end
...
- (void)viewDidLoad
{
    ...
    //搜索展示控制器
    //参数①:要控制的搜索框
    //参数②:要在哪个视图控制器之上展示搜索结果
    UISearchDisplayController *searchDisplayController = [[UISearchDisplayController alloc] initWithSearchBar:searchBar contentsController:self];
    
    
    //创建搜索代理人
    _searchDisplayDelegate = [[SearchDisplayDelegate alloc] initWithSearchDisplayController:searchDisplayController];
    //给代理人提供原始数据
    _searchDisplayDelegate.originalData = _names;
