...
- (void)viewDidLoad {
    ...
    //昵称
    nameLabel = [[UILabel alloc]initWithFrame:CGRectMake(180, 150, 100, 50)];
    //头像
    imageView = [[UIImageView alloc]initWithFrame:CGRectMake(30, 100, 150, 150)];
